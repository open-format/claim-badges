...
const tabsTriggerVariants = cva("inline-flex items-center justify-center", {
  variants: {
    variant: {
      ...
      outline:
        "px-3 py-1.5 text-sm ring-offset-background transition-all data-[state=active]:border-b-2 data-[state=active]:border-white data-[state=active]:text-white data-[state=active]:font-bold text-muted-white",
      // Add more variants here
    },
  },
  defaultVariants: {
